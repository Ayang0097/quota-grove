...
- 每 10 秒扫描一次本机 Codex 额度记录；双击或右键可立即刷新，不请求网络也不消耗 Token。
...
`--snapshot-json` 只输出标准化额度快照。`--self-test` 覆盖 52 项主题边界、视觉规则、落叶粒子密度、风场与中段分层、重力与景深退场、额度日志防回退、解析和中英文切换检查，包括 PRD 指定的 50、49、20、19、3、2、1、0 八个主题边界。
