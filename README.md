...
- 悬停收纳条：临时滑出完整卡片。
- 右键：打开刷新、天气联动、登录启动、位置重置、隐私和退出菜单。
...
`--snapshot-json` 只输出标准化额度快照。`--self-test` 覆盖 69 项主题边界、视觉规则、落叶、雨滴与雪花粒子、天气判定、额度日志防回退、解析和中英文切换检查，包括 PRD 指定的 50、49、20、19、3、2、1、0 八个主题边界。
